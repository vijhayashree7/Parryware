...
const images = [
  "media__1774867657272.png",
  "media__1774867666434.png",
  "media__1774867676210.jpg",
  "media__1774867685115.png",
  "media__1774867715750.png"
];

const mappings = [
  { img: images[0], name: 'praseo_1' },
  { img: images[0], name: 'praseo_2' },
  { img: images[1], name: 'praseo_3' },
  { img: images[1], name: 'praseo_4' },
  { img: images[2], name: 'praseo_5' },
  { img: images[2], name: 'praseo_6' },
  { img: images[3], name: 'praseo_7' },
  { img: images[4], name: 'praseo_8' },
];
...
const products = [
  {
    id: 1,
    name: 'Praseo Classic Chrome Faucet',
    description: 'Defined by elegant curves and a timeless chrome finish, the Praseo collection brings classic sophistication to modern bathrooms.',
    price: 4500,
    mrp: 5500,
    image: '/images/faucets/praseo_1.png',
    rating: 4.8,
    reviews: 1124
  },
  {
    ...
    price: 2500,
    mrp: 3500,
    image: '/images/faucets/praseo_2.png',
    rating: 4.6,
    reviews: 842
  },
  {
    id: 3,
    name: 'Quattro Bold Geometric Faucet',
    description: 'A bold geometric design with sharp edges and clean lines, perfect for contemporary and architectural bathroom spaces.',
    price: 5500,
    mrp: 6500,
    image: '/images/faucets/praseo_3.png',
    rating: 4.9,
    reviews: 588
  },
  {
    ...
    price: 3000,
    mrp: 4000,
    image: '/images/faucets/praseo_4.png',
    rating: 4.7,
    reviews: 320
  },
  {
    id: 5,
    name: 'Elara Warm Metallic Faucet',
    description: 'Crafted with a warm metallic finish, Elara blends luxury and softness to create a rich, inviting bathroom ambiance.',
    price: 6500,
    mrp: 7500,
    image: '/images/faucets/praseo_5.jpg',
    rating: 4.9,
    reviews: 415
  },
  {
    ...
    price: 4000,
    mrp: 5200,
    image: '/images/faucets/praseo_6.jpg',
    rating: 4.5,
    reviews: 198
  },
  {
    id: 7,
    name: 'Nero Minimal Matte Black Faucet',
    description: 'A bold matte black finish with a minimal silhouette, designed for modern bathrooms with a strong visual identity.',
    price: 3500,
    mrp: 6000,
    image: '/images/faucets/praseo_7.png',
    rating: 4.8,
    reviews: 254
  },
  {
    id: 8,
    name: 'Aurum Opulence Gold Faucet',
    description: 'Inspired by opulence, the Aurum collection features a rich golden finish that elevates your bathroom into a luxury statement space.',
    price: 8000,
    mrp: 9500,
    image: '/images/faucets/praseo_8.png',
    rating: 5.0,
    reviews: 112
  }
];
...
`;
fs.writeFileSync('c:\\Users\\asus0\\Parryware\\src\\components\\PraseoCollection.jsx', template);
console.log('Build perfectly completed!');
