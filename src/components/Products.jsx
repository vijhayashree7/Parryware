...
const categories = [
  { id: 0, title: 'Water Heater', bgImage: '/images/heater.png', desc: 'Instant & Storage Systems' },
  { id: 1, title: 'Closet', bgImage: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80', desc: 'Smart & Premium Designs' },
  { id: 2, title: 'Basin', bgImage: '/images/basin.png', desc: 'Countertop & Wall Hung' },
  { id: 3, title: 'Faucets', bgImage: '/images/faucet.png', desc: 'Elegant Chrome & Matte' },
  { id: 4, title: 'Chimney', bgImage: '/images/chimney.png', desc: 'Slanted & Island Models' },
  { id: 5, title: 'Tiles and Surface', bgImage: '/images/tiles.jpg', desc: 'Large Format & Marble' }
];
